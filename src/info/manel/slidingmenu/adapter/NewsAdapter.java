...
public class NewsAdapter extends BaseAdapter {
	    ...
	    public NewsAdapter(Activity activity, Context context, ArrayList<RSSFeed> listP)
	    ...
	    public View getView(int position, View convertView, ViewGroup parent)
	    {
			...
			if (convertView == null)
			{
				...
				convertView = layoutInflater.inflate(R.layout.my_news_item_adapter, null);
				holder = new ViewHolder();
//				holder.newsBackground = (ImageView) convertView.findViewById(R.id.my_news_background);
				
				holder.descriptionNews = (TextView) convertView.findViewById(R.id.description_news);
				
				holder.dateNews= (TextView) convertView.findViewById(R.id.date_news);
...
//		        
	     ...
	     String image="http://www.mosaiquefm.net/uploads/content/thumbnails_small/1461423453_article.jpg";
